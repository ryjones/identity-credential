...
class CloudCreateKeySettings private constructor(
    ...
    class Builder(private val attestationChallenge: ByteArray) {
        ...
        private var userAuthenticationTypes = setOf<CloudSecureAreaUserAuthType>()
        ...
        fun applyConfiguration(configuration: SecureAreaConfigurationCloud) = apply {
            ...
            setUserAuthenticationRequired(
                ...
                configuration.userAuthenticationTypes.toCloudSecureAreaUserAuthType()
            )
        }
         ...
         * @param types a combination of the flags [CloudSecureAreaUserAuthType.KNOWLEDGE_FACTOR]
         *     and [CloudSecureAreaUserAuthType.BIOMETRIC]. Cannot be empty if [required] is `true`.
         * @return the builder.
         */
        fun setUserAuthenticationRequired(
            required: Boolean,
            types: Set<CloudSecureAreaUserAuthType>
        ) = apply {
