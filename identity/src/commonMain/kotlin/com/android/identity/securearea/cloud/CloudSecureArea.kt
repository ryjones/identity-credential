...
internal expect suspend fun cloudSecureAreaGetPlatformSecureArea(): SecureArea
...
open class CloudSecureArea protected constructor(
    ...
    suspend fun register(
        ...
        try {
            ...
            val deviceAttestationResult = DeviceCheck.generateAttestation(
                cloudSecureAreaGetPlatformSecureArea(),
                response0.deviceCheckClientId
            )
            val deviceAssertion = DeviceCheck.generateAssertion(
                cloudSecureAreaGetPlatformSecureArea(),
                deviceAttestationResult.deviceAttestationId,
                AssertionNonce(ByteString(response0.cloudChallenge))
            )
    ...
    private fun validateCloudBindingKeyAttestation(
        ...
        val attestation = CloudSecureAreaAttestationExtension.decode(ByteString(
            attestation.certificates[0]
                .getExtensionValue(OID.X509_EXTENSION_MULTIPAZ_CSA_KEY_ATTESTATION.oid)!!
        ))
    ...
    private suspend fun setupE2EE(forceSetup: Boolean) {
        ...
        try {
            ...
            val deviceAssertion = DeviceCheck.generateAssertion(
                secureArea = cloudSecureAreaGetPlatformSecureArea(),
    ...
    override suspend fun createKey(
        ...
        try {
            ...
            val request0 = CreateKeyRequest0(
                ...
                CloudSecureAreaUserAuthType.encodeSet(cSettings.userAuthenticationTypes),
    ...
    override suspend fun getKeyInfo(alias: String): CloudKeyInfo {
        ...
        val userAuthenticationTypes = map["userAuthenticationTypes"].asNumber.toCloudSecureAreaUserAuthType()
    ...
    private suspend fun saveKeyMetadata(
        ...
        map.put("userAuthenticationTypes", CloudSecureAreaUserAuthType.encodeSet(settings.userAuthenticationTypes))
