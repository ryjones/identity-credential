...
fun ByteArray.putUInt8(offset: Int, value: Int, validRange: IntRange = 0..UByte.MAX_VALUE.toInt()) {
    require(value in validRange) { "Value $value is out of UInt8 range" }
    this[offset] = value.toByte()
}

fun ByteArray.putUInt16(offset: Int, value: Int, validRange: IntRange = 0..UShort.MAX_VALUE.toInt()) {
    require(value in validRange) { "Value $value is out of UInt16 range" }
    this[offset] = ((value shr 8) and 0xFF).toByte()
    this[offset + 1] = (value and 0xFF).toByte()
}

fun ByteArray.putUInt16Le(offset: Int, value: Int, validRange: IntRange = 0..UShort.MAX_VALUE.toInt()) {
    require(value in validRange) { "Value $value is out of UInt16 range" }
    this[offset] = (value and 0xFF).toByte()
    this[offset + 1] = ((value shr 8) and 0xFF).toByte()
}

fun ByteArray.putUInt32(offset: Int, value: Int, validRange: IntRange = 0..Int.MAX_VALUE) {
    require(value in validRange) { "Value $value is out of Int32 range" }
    this[offset] = ((value shr 24) and 0xFF).toByte()
    this[offset + 1] = ((value shr 16) and 0xFF).toByte()
    this[offset + 2] = ((value shr 8) and 0xFF).toByte()
...
fun ByteArray.putUInt32Le(offset: Int, value: Int, validRange: IntRange = 0..Int.MAX_VALUE) {
    require(value in validRange) { "Value $value is out of Int32 range" }
    this[offset] = (value and 0xFF).toByte()
    this[offset + 1] = ((value shr 8) and 0xFF).toByte()
    this[offset + 2] = ((value shr 16) and 0xFF).toByte()
...
fun ByteArray.putUInt64(offset: Int, value: Long, validRange: LongRange = 0..Long.MAX_VALUE) {
    require(value in validRange) { "Value $value is out of Int64 range" }
    this[offset] = ((value shr 56) and 0xFF).toByte()
    this[offset + 1] = ((value shr 48) and 0xFF).toByte()
    this[offset + 2] = ((value shr 40) and 0xFF).toByte()
...
fun ByteArray.putUInt64Le(offset: Int, value: Long, validRange: LongRange = 0..Long.MAX_VALUE) {
    require(value in validRange) { "Value $value is out of Int64 range" }
    this[offset] = (value and 0xFF).toByte()
    this[offset + 1] = ((value shr 8) and 0xFF).toByte()
    this[offset + 2] = ((value shr 16) and 0xFF).toByte()
