...
fun ByteStringBuilder.appendUInt8(
    value: Int,
    validRange: IntRange = 0..UByte.MAX_VALUE.toInt())
{
...
fun ByteStringBuilder.appendUInt16(
    value: Int,
    validRange: IntRange = 0..UShort.MAX_VALUE.toInt()
) {
...
fun ByteStringBuilder.appendUInt32(value: Int, validRange: IntRange = 0..Int.MAX_VALUE) {
...
fun ByteStringBuilder.appendUInt32Le(value: Int, validRange: IntRange = 0..Int.MAX_VALUE) {
    require(value in validRange) { "Value $value is out of UInt32 range" }
    append((value shr 0).toByte())
    append((value shr 8).toByte())
    append((value shr 16).toByte())
...
fun ByteStringBuilder.appendUInt64Be(value: Long, validRange: LongRange = 0..Long.MAX_VALUE) {
...
fun ByteStringBuilder.appendUInt64Le(value: Long, validRange: LongRange = 0..Long.MAX_VALUE) {
    require(value in validRange) { "Value $value is out of UInt64 range" }
    append((value shr 0).toByte())
    append((value shr 8).toByte())
    append((value shr 16).toByte())
