...
class ByteStringBuilderExtensionsTest {
    ...
    fun appendInt16_withinRange() {
        assertDoesNotThrow { buildByteString { appendInt16Le(Short.MIN_VALUE.toInt(), Short.MIN_VALUE..Short.MAX_VALUE) } }
        assertDoesNotThrow { buildByteString { appendInt16Le(0, Short.MIN_VALUE..Short.MAX_VALUE) } }
        assertDoesNotThrow { buildByteString { appendInt16Le(Short.MAX_VALUE.toInt(), Short.MIN_VALUE..Short.MAX_VALUE) } }
    }
    ...
    fun appendUInt16_withinRange() {
        assertDoesNotThrow { buildByteString { appendUInt16Le(UShort.MIN_VALUE.toInt()) } }
        assertDoesNotThrow { buildByteString { appendUInt16Le(32768) } }
        assertDoesNotThrow { buildByteString { appendUInt16Le(UShort.MAX_VALUE.toInt()) } }
    }

    @Test
    fun appendUInt16_outOfRange() {
        assertFailsWith<IllegalArgumentException> { buildByteString { appendUInt16Le(UShort.MIN_VALUE.toInt() - 1) } }
        assertFailsWith<IllegalArgumentException> { buildByteString { appendUInt16Le(UShort.MAX_VALUE.toInt() + 1) } }
    }

    @Test
    fun appendUInt16_readBack() {
        val byteString = buildByteString { appendUInt16Le(50000) }
        assertEquals(50000u, byteString.toByteArray().getUInt16Le(0))
    }

    @Test
    fun appendUInt32_valid() {
        val byteString = buildByteString { appendUInt32Le(UInt.MIN_VALUE.toInt()) }
        assertEquals(UInt.MIN_VALUE, byteString.toByteArray().getUInt32Le(0))

        val byteString2 = buildByteString { appendUInt32Le(2147483647) }
        assertEquals(2147483647u, byteString2.toByteArray().getUInt32Le(0))

        // The Int input should not be of UInt full range.
        assertFailsWith<IllegalArgumentException> { buildByteString { appendUInt32Le(UInt.MAX_VALUE.toInt()) }}
    }

    @Test
    fun appendUInt32_outOfRange() {
        assertFailsWith<IllegalArgumentException> { buildByteString { appendUInt32Le(-1) } }
    }

    @Test
    fun appendUInt64_valid() {
        val byteString = buildByteString { appendUInt64Le(ULong.MIN_VALUE.toLong()) }
        assertEquals(ULong.MIN_VALUE, byteString.toByteArray().getUInt64Le(0))

        val byteString2 = buildByteString { appendUInt64Le(4294967295) }
        assertEquals(4294967295u, byteString2.toByteArray().getUInt64Le(0))

        // The Long input should not be of ULong full range.
        assertFailsWith<IllegalArgumentException> { buildByteString { appendUInt64Le(ULong.MAX_VALUE.toLong()) } }
    }

    @Test
    fun appendUInt64_outOfRange() {
        assertFailsWith<IllegalArgumentException> { buildByteString { appendUInt64Le(-1) } }
    }
...
// Readers
    ...
    fun testGetInt32_maxInt() {
        assertEquals(0x7FFFFFFF, ByteString(byteArrayOf(0x7F, 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte())).getInt32(0))
        assertEquals(0x7FFFFFFF, ByteString(byteArrayOf(0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0x7F)).getInt32Le(0))
    }
    ...
    fun testGetInt32_negative() {
        assertEquals(-1, ByteString(byteArrayOf(0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte())).getInt32(0))
        assertEquals(-1, ByteString(byteArrayOf(0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte())).getInt32Le(0))
    }
    @Test
    ...
    fun testGetInt64_validData() {
        assertEquals(0x0102030405060708L, ByteString(byteArrayOf(0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08)).getInt64(0))
        assertEquals(0x0807060504030201L, ByteString(byteArrayOf(0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08)).getInt64Le(0))
    }

    @Test
    fun testGetInt64_validDataWithOffset() {
        assertEquals(0x0203040506070809L, ByteString(byteArrayOf(0x00, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09)).getInt64(1))
        assertEquals(0x0908070605040302L, ByteString(byteArrayOf(0x00, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09)).getInt64Le(1))
    }
    ...
    fun testGetInt64_maxLong() {
        assertEquals(0x7FFFFFFFFFFFFFFFL, ByteString(byteArrayOf(0x7F, 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte())).getInt64(0))
        assertEquals(0x7FFFFFFFFFFFFFFFL, ByteString(byteArrayOf(0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0x7F)).getInt64Le(0))
    }

    @Test
    fun testGetInt64_minLong() {
        assertEquals(-0x7FFFFFFFFFFFFFFFL-1, ByteString(byteArrayOf(0x80.toByte(), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00)).getInt64(0))
        assertEquals(-0x7FFFFFFFFFFFFFFFL-1, ByteString(byteArrayOf(0x00.toByte(), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80.toByte())).getInt64Le(0))
    }
    @Test
    fun testGetInt64_negative() {
        assertEquals(-1L, ByteString(byteArrayOf(0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte())).getInt64(0))
        assertEquals(-1L, ByteString(byteArrayOf(0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte())).getInt64Le(0))
    }

    @Test
    fun testGetInt64_offsetTooLarge() {
        assertFailsWith<IllegalArgumentException> { ByteString(byteArrayOf(0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08)).getInt64(1) }
        assertFailsWith<IllegalArgumentException> { ByteString(byteArrayOf(0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08)).getInt64Le(1) }
    }
    ...
    fun testGetInt64_sevenBytes() {
        assertFailsWith<IllegalArgumentException> { ByteString(byteArrayOf(0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07)).getInt64(0) }
        assertFailsWith<IllegalArgumentException> { ByteString(byteArrayOf(0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07)).getInt64Le(0) }
    }
    ...
    fun testGetUInt32Be_maxUInt() {
        assertEquals(UInt.MAX_VALUE, ByteString(byteArrayOf(0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte())).getUInt32(0))
        assertEquals(UInt.MAX_VALUE, ByteString(byteArrayOf(0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte())).getUInt32Le(0))
    }
    ...
    fun testGetUInt64_validData() {
        assertEquals(0x0102030405060708uL, ByteString(byteArrayOf(0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08)).getUInt64(0))
        assertEquals(0x0807060504030201uL, ByteString(byteArrayOf(0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08)).getUInt64Le(0))
    }

    @Test
    fun testGetUInt64_validDataWithOffset() {
        assertEquals(0x0102030405060708uL, ByteString(byteArrayOf(0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09)).getUInt64(1))
        assertEquals(0x0807060504030201uL, ByteString(byteArrayOf(0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09)).getUInt64Le(1))
    }
    ...
    fun testGetUInt64_maxULong() {
        assertEquals(ULong.MAX_VALUE, ByteString(byteArrayOf(0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte())).getUInt64(0))
        assertEquals(ULong.MAX_VALUE, ByteString(byteArrayOf(0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte())).getUInt64Le(0))
    }

    @Test
    fun testGetUInt64_minULong() {
        assertEquals(ULong.MIN_VALUE, ByteString(byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00)).getUInt64(0))
        assertEquals(ULong.MIN_VALUE, ByteString(byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00)).getUInt64Le(0))
    }

    @Test
    fun testGetUInt64_offsetTooLarge() {
        assertFailsWith<IllegalArgumentException> { ByteString(byteArrayOf(0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08)).getUInt64(1) }
        assertFailsWith<IllegalArgumentException> { ByteString(byteArrayOf(0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08)).getUInt64Le(1) }
    }
