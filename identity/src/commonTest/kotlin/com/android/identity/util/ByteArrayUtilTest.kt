...
class ByteArrayUtilTest {
    ...
    fun putUInt8_outOfRange() {
        val byteArray = ByteArray(1)
        assertFailsWith<IllegalArgumentException> { byteArray.putUInt8(0, UByte.MIN_VALUE.toInt() - 1) }
        assertFailsWith<IllegalArgumentException> { byteArray.putUInt8(0, UByte.MAX_VALUE.toInt() + 1) }
    }

    @Test
    fun putUInt16_valid() {
        val byteArray = ByteArray(2)
        byteArray.putUInt16(0, 0x0102)
        assertEquals("0102", byteArray.toHex())
        byteArray.putUInt16Le(0, 0x0102)
        assertEquals("0201", byteArray.toHex())
    }
    ...
    fun putUInt16_outOfRange() {
        val byteArray = ByteArray(2)
        assertFailsWith<IllegalArgumentException> { byteArray.putUInt16(0, UShort.MIN_VALUE.toInt() - 1) }
        assertFailsWith<IllegalArgumentException> { byteArray.putUInt16(0, UShort.MAX_VALUE.toInt() + 1) }
        assertFailsWith<IllegalArgumentException> { byteArray.putUInt16Le(0, UShort.MIN_VALUE.toInt() - 1) }
        assertFailsWith<IllegalArgumentException> { byteArray.putUInt16Le(0, UShort.MAX_VALUE.toInt() + 1) }
    }

    @Test
    fun putUInt32_valid() {
        val byteArray = ByteArray(4)
        byteArray.putUInt32(0, 0x01020304)
        assertEquals("01020304", byteArray.toHex())
        byteArray.putUInt32Le(0, 0x01020304)
        assertEquals("04030201", byteArray.toHex())
    }
    ...
    fun putUInt32_outOfRange() {
        val byteArray = ByteArray(4)
        assertFailsWith<IllegalArgumentException> { byteArray.putUInt32(0, -1) }
        assertFailsWith<IllegalArgumentException> { byteArray.putUInt32Le(0, -1) }

        // The Int input should not be of UInt full range.
        assertFailsWith<IllegalArgumentException> { byteArray.putUInt32(0, UInt.MAX_VALUE.toInt()) }
        assertFailsWith<IllegalArgumentException> { byteArray.putUInt32Le(0, UInt.MAX_VALUE.toInt()) }
    }

    @Test
    fun putUInt64_valid() {
        val byteArray = ByteArray(8)
        byteArray.putUInt64(0, 0x0102030405060708)
        assertEquals("0102030405060708", byteArray.toHex())
        byteArray.putUInt64Le(0, 0x0102030405060708)
        assertEquals("0807060504030201", byteArray.toHex())
    }
    ...
    fun putUInt64_outOfRange() {
        val byteArray = ByteArray(8)
        assertFailsWith<IllegalArgumentException> { byteArray.putUInt64(0, -1) }
        assertFailsWith<IllegalArgumentException> { byteArray.putUInt64Le(0, -1) }

        // The Long input should not be of ULong full range.
        assertFailsWith<IllegalArgumentException> { byteArray.putUInt64(0, ULong.MAX_VALUE.toLong()) }
        assertFailsWith<IllegalArgumentException> { byteArray.putUInt64Le(0, ULong.MAX_VALUE.toLong()) }
    }
    ...
    fun getUInt8_roundtrip() {
        val byteArray = ByteArray(1)
        byteArray.putUInt8(0, UByte.MIN_VALUE.toInt())
        assertEquals(UByte.MIN_VALUE, byteArray.getUInt8(0))

        byteArray.putUInt8(0, 128)
        assertEquals(128u, byteArray.getUInt8(0))

        byteArray.putUInt8(0, UByte.MAX_VALUE.toInt())
    ...
    fun getUInt32_roundtrip() {
        val byteArray = ByteArray(4)
        byteArray.putUInt32(0, UInt.MIN_VALUE.toInt())
        assertEquals(UInt.MIN_VALUE, byteArray.getUInt32(0))

        byteArray.putUInt32(0, 2147483647)
        assertEquals(2147483647u, byteArray.getUInt32(0))

        byteArray.putUInt32Le(0, UInt.MIN_VALUE.toInt())
        assertEquals(UInt.MIN_VALUE, byteArray.getUInt32Le(0))

        byteArray.putUInt32Le(0, 2147483647)
    ...
    fun getUInt64_roundtrip() {
        val byteArray = ByteArray(8)
        byteArray.putUInt64(0, ULong.MIN_VALUE.toLong())
        assertEquals(ULong.MIN_VALUE, byteArray.getUInt64(0))

        byteArray.putUInt64(0, 4294967295)
        assertEquals(4294967295u, byteArray.getUInt64(0))

        byteArray.putUInt64Le(0, ULong.MIN_VALUE.toLong())
        assertEquals(ULong.MIN_VALUE, byteArray.getUInt64Le(0))

        byteArray.putUInt64Le(0, 4294967295)
    ...
    fun getUInt32_offset() {
        val byteArray = ByteArray(6)
        byteArray.putUInt32Le(2, 3000000)
    ...
    fun getUInt64_offset() {
        val byteArray = ByteArray(10)
        byteArray.putUInt64Le(2, 10000000000)
