...
import com.android.identity.securearea.cloud.CloudSecureAreaUserAuthType
            ...
            for ((curve, curveName, purposes) in arrayOf(
                ...
                for ((passphraseRequired, passphraseDescription) in arrayOf(
                    ...
                    for ((userAuthRequired, userAuthTypes, authDesc) in listOf(
                        Triple(false, setOf(), ""),
                        Triple(true, setOf(CloudSecureAreaUserAuthType.KNOWLEDGE_FACTOR), "- Auth (PIN only)"),
                        Triple(true, setOf(CloudSecureAreaUserAuthType.BIOMETRIC), "- Auth (Biometric only)"),
                        Triple(true, setOf(
...
private suspend fun csaTest(
    ...
    authTypes: Set<CloudSecureAreaUserAuthType>,
